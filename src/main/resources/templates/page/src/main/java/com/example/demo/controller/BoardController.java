...
//	}
	...
	public String writeContent(ContentVO content, HttpSession session) {
		String loginId = (String)session.getAttribute("loginId");
		if(loginId != null && loginId.length()>0) {
			service.writeContent(content, loginId);
	...
	public ModelAndView updateContent(ContentVO content, HttpSession session) {
		String loginId = (String)session.getAttribute("loginId");
		
		boolean result = service.updateContent(content, loginId);
		ModelAndView mv = new ModelAndView();
